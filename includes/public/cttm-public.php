...
function cttm_scripts_frontend()
{
	...
	wp_register_script('leaflet_markercluster', plugins_url('js/leaflet/leaflet.markercluster.js', __FILE__));
	...
	wp_register_script('leaflet_fullscreen', plugins_url('js/leaflet/Leaflet.fullscreen.min.js', __FILE__));
}
